...
# =============================================================================
# Getting the sp-index call data and our initial values
# =============================================================================
...
df["Marche"]=(df.iloc[:,2]+df.iloc[:,3])/2
# =============================================================================
# Call Function
# =============================================================================
...
# =============================================================================
# Market price and black scholes difference
# =============================================================================
def F(marche,t,S,K,T,r,sigma):
    return Call_BS(t, S, K, T, r, sigma)-marche
# =============================================================================
# New df columns and Newton's algorithm
# =============================================================================
...
for i in range(0,280):
    if np.max(+df.loc[i,"S0"]-df.loc[i,"K"]*np.exp(-df.loc[i,"r"]*df.loc[i,"T"]),0)<df.loc[i,"Marche"]<df.loc[i,"S0"]:
...
# =============================================================================
# Dropping arbitrage values and plotting the vol smiles
# =============================================================================
df = df[df.Sigma != 0]
fig = plt.figure()
...
ax.set_xlabel('Time')
ax.set_zlabel('\u03C3')
ax.set_title("Volatility Smile SPIndexCall")
plt.show()
plt.xlabel("K")
plt.ylabel("\u03C3")
plt.title("Volatility Smile for the first maturity")
plt.plot(df.loc[:71,"K"],df.loc[:71,"Sigma"])
